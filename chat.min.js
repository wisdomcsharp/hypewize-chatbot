...
`,$=document.createElement("div");$.setAttribute("id","chat-bubble-button"),$.style.position="fixed",$.style.bottom="20px",$.style.width="60px",$.style.height="60px",$.style.borderRadius="30px",$.style.backgroundColor="purple",$.style.boxShadow="0 4px 8px 0 rgba(0, 0, 0, 0.2)",$.style.cursor="pointer",$.style.zIndex=999999999,$.style.transition="all .2s ease-in-out",$.addEventListener("mouseenter",e=>{$.style.transform="scale(1.05)"}),$.addEventListener("mouseleave",e=>{$.style.transform="scale(1)"});let _=document.createElement("div");_.style.display="flex",_.style.alignItems="center",_.style.justifyContent="center",_.style.width="100%",_.style.height="100%",_.style.zIndex=999999999,_.innerHTML=e,$.appendChild(_);let l=document.createElement("div");l.style.position="absolute",l.style.top="-7px",l.style.right="-1px",l.style.width="20px",l.style.height="20px",l.style.borderRadius="50%",l.style.backgroundColor="red",l.style.color="white",l.style.display="flex",l.style.alignItems="center",l.style.justifyContent="center",l.style.zIndex=1e9,l.style.fontSize="12px",l.innerHTML="1",$.appendChild(l);let s=!0;function i(){window.innerHeight<600&&(n.style.height="70vh")}$.addEventListener("click",()=>{s&&(l.style.display="none",s=!1),"none"===n.style.display?(n.style.display="flex",_.innerHTML=t):(n.style.display="none",_.innerHTML=e)});let n=document.createElement("div");n.setAttribute("id","chat-bubble-window"),n.style.position="fixed",n.style.flexDirection="column",n.style.justifyContent="space-between",n.style.bottom="80px",n.style.width="85vw",n.style.height="70vh",n.style.boxShadow="rgba(150, 150, 150, 0.15) 0px 6px 24px 0px, rgba(150, 150, 150, 0.15) 0px 0px 0px 1px",n.style.display="none",n.style.borderRadius="10px",n.style.zIndex=999999999,n.style.overflow="hidden",window.addEventListener("resize",i),i();let d=document.currentScript;console.log(d);let o=d.id.substring(0,d.id.indexOf("-")).trim(),r=d.id.replace(/.*?-/,"").trim();function y(){n.innerHTML=`<iframe
    src="https://hypewize.com/chatbot/${d.id}"
    width="100%"
    height="100%"
    frameborder="0"
    ></iframe>`,document.body.appendChild(n);(async()=>{$.style.right="20px",$.style.left="unset",n.style.right="20px",n.style.left="unset",document.body.appendChild($)})()}console.log("botID: ",r),console.log("botName: ",o),"complete"===document.readyState?y():window.addEventListener("load",y);let a=window.matchMedia("(min-width: 550px)");function p(e){e.matches&&(n.style.height="600px",n.style.width="450px")}a.addEventListener("change",p),p(a)}();