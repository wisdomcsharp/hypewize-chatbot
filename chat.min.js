...
`,s=document.createElement("div");s.setAttribute("id","chat-bubble-button"),s.style.position="fixed",s.style.bottom="20px",s.style.width=e+"px",s.style.height=e+"px",s.style.borderRadius=t+"px",s.style.backgroundColor=$,s.style.boxShadow="0 4px 8px 0 rgba(0, 0, 0, 0.2)",s.style.cursor="pointer",s.style.zIndex=999999999,s.style.transition="all .2s ease-in-out",s.addEventListener("mouseenter",e=>{s.style.transform="scale(1.05)"}),s.addEventListener("mouseleave",e=>{s.style.transform="scale(1)"});let i=document.createElement("div");i.style.display="flex",i.style.alignItems="center",i.style.justifyContent="center",i.style.width="100%",i.style.height="100%",i.style.zIndex=999999999,i.innerHTML=_,s.appendChild(i);let n=document.createElement("div");n.style.position="absolute",n.style.top="-7px",n.style.right="-1px",n.style.width="20px",n.style.height="20px",n.style.borderRadius="50%",n.style.backgroundColor="red",n.style.color="white",n.style.display="flex",n.style.alignItems="center",n.style.justifyContent="center",n.style.zIndex=1e9,n.style.fontSize="12px",n.innerHTML="1",s.appendChild(n);let d=!0;function o(){window.innerHeight<600&&(r.style.height="70vh")}s.addEventListener("click",()=>{d&&(n.style.display="none",d=!1),"none"===r.style.display?(r.style.display="flex",i.innerHTML=l):(r.style.display="none",i.innerHTML=_)});let r=document.createElement("div");r.setAttribute("id","chat-bubble-window"),r.style.position="fixed",r.style.flexDirection="column",r.style.justifyContent="space-between",r.style.bottom="80px",r.style.width="85vw",r.style.height="70vh",r.style.boxShadow="rgba(150, 150, 150, 0.15) 0px 6px 24px 0px, rgba(150, 150, 150, 0.15) 0px 0px 0px 1px",r.style.display="none",r.style.borderRadius="10px",r.style.zIndex=999999999,r.style.overflow="hidden",window.addEventListener("resize",o),o();let y=document.currentScript;console.log(y);let a=y.id.substring(0,y.id.indexOf("-")).trim(),p=y.id.replace(/.*?-/,"").trim();function h(){r.innerHTML=`<iframe
    src="https://app.hypewize.com/projects/chatbot/${y.id}"
    width="100%"
    height="100%"
    frameborder="0"
    ></iframe>`,document.body.appendChild(r);(async()=>{s.style.right="20px",s.style.left="unset",r.style.right="20px",r.style.left="unset",document.body.appendChild(s)})()}console.log("botID: ",p),console.log("botName: ",a),"complete"===document.readyState?h():window.addEventListener("load",h);let C=window.matchMedia("(min-width: 550px)");function x(e){e.matches&&(r.style.height="600px",r.style.width="450px")}C.addEventListener("change",x),x(C)}